...
def main(sr_number, reduced_frequency, time_step, iteration):
    start = time.time()
    ...
    free_velocity = get_free_vel(re_num, viscosity, density)
    ...
    # time_step = 0.002
    current_time = 0.0
    # iteration = 1700  # use maximum iterations as 3500. otherwise it will get memory error
...
# sr = [0.06]  # straouhal number
# k = [(i + 1) * 0.01 for i in range(1,20)]  # reduced frequency
# t_s = [0.02, 	0.01, 	0.01, 	0.005, 	0.005, 	0.005, 	0.005, 	0.005, 	0.002, 	0.002, 	0.002, 	0.002, 	0.002, 	0.002, 	0.002, 	0.002, 	0.002, 	0.001, 	0.001, 	0.001]  # time step
# itera = [2301, 2301, 1584, 2301, 1870, 1584, 1379, 1225, 2540, 2301, 2105, 1942, 1804, 1686, 1584, 1494, 1415, 2540, 2414, 2301]  # iteration

sr = [0.19]  # straouhal number
k = [(i + 1) * 0.01 for i in range(20)]  # reduced frequency
t_s = [0.02, 0.01, 0.01, 0.005, 0.005, 0.005, 0.005, 0.005, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002, 0.002,
       0.002, 0.001, 0.001, 0.001]  # time step
itera = [2301, 2301, 1584, 2301, 1870, 1584, 1379, 1225, 2540, 2301, 2105, 1942, 1804, 1686, 1584, 1494, 1415, 2540,
         2414, 2301]
