...
def write_array(circulation, te_vortex_z, te_vortex_strength, iterate_time_step):
    heading = 'result_file.txt'
    file1 = open(heading, "a+")
    file1.write(str(list(circulation)) + '\n')
    file1.write(str(list(te_vortex_strength)) + '\n')
    file1.write(str(list(te_vortex_z)) + '\n')
    file1.write(str(list(iterate_time_step)) + '\n')
    file1.close()
...
# ----- write in a file
make_file(airfoil, N, radius, center_circle, trailing_edge_z, Gkn, z_plane, v_plane, u_plane,
             free_velocity, free_aoa, pl_amplitude, pl_frequency, pi_amplitude, pi_frequency,
             time_step, current_time, iteration, distance, angle)
...
write_array(circulation_list, te_vortex_z, te_vortex_strength, iterate_time_step)
