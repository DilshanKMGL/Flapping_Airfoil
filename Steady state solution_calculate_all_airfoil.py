...
def make_file(airfoil, free_velocity, free_aoa, end_aoa, re_num, density, viscosity, heading):
...
for airfoil_number in airfoil_list:
    ...
    heading = 'Steady_state_solution_results/' + airfoil + ' - potential flow.txt'
    ...
    make_file(airfoil, free_velocity, free_aoa, end_aoa, re_num, density, viscosity, heading)
    print(airfoil)
